...
const WalletTransactions = ({match, payments, status, paymentsCount, auth_id, getPayments, header, loading, getPaymentsServiceCount, paymentsServiceBalance, getPaymentsServiceBalance}) => {
  ...
  return (
    <div className="table-wrapper">
      <PageTitleBar title={"Wallet Transactions"} match={match} />
      <div>
        <RctCollapsibleCard heading={"Wallet Transactions"} fullBlock style={{minHeight: "70vh"}}>
