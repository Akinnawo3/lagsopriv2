...
const PartnerTable = ({loading, header, partners, partnersCount, getPartners, getUserExport, getPartnersCount, searchPartners, createPartners, status = "", deleteUser}) => {
                  ...
                  <Fragment>
                    {partners.map((partner, key) => (
                      <TableRow hover key={key}>
                        ...
                        <TableCell>
                          <Badge color={partner?.partner_data?.partner_status === 4 ? "success" : partner?.partner_data?.partner_status === 2 ? "primary" : "warning"}>
                            {partner?.partner_data?.partner_status === 4 ? "Approved" : partner?.partner_data?.partner_status === 2 ? "Verified" : "Pending"}
                          </Badge>
                        </TableCell>
                        <TableCell>
        ...
        >
          <ModalBody>
            ...
            <FormGroup>
              ...
              <Input
                type="select"
                value={vehicle_interested?.has_driver}
                onChange={(e) => setFormData({...formData, vehicle_interested: {...vehicle_interested, has_driver: e.target.value, amount: e.target.value === "0" ? "140000" : ""}})}
                required
              >
            ...
            <FormGroup>
              ...
              <Input
                readOnly={vehicle_interested?.has_driver === "0"}
                type="number"
                value={vehicle_interested?.amount}
                onChange={(e) => setFormData({...formData, vehicle_interested: {...vehicle_interested, amount: e.target.value}})}
                required
              />
            </FormGroup>
            <FormGroup>
              ...
              <Input
                type="select"
                value={partner_driver_payment?.type}
                onChange={(e) => setFormData({...formData, partner_driver_payment: {...partner_driver_payment, type: e.target.value}})}
                required
              >
            ...
            <FormGroup>
              ...
              <Input
                ...
                onChange={(e) => setFormData({...formData, partner_driver_payment: {...partner_driver_payment, driver_payment: e.target.value}})}
                required
              />
            </FormGroup>
          </ModalBody>
