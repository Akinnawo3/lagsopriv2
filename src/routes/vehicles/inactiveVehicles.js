...
const  InactiveVehicles = ({match,getVehicles, vehicles, isLoading, createVehicle}) => {
				...
				<RctCollapsibleCard heading="All Vehicles" fullBlock>
					...
					<div className="table-responsive">
						<Table>
							...
							<TableBody>
								<Fragment>
									{vehicles && vehicles.filter(vehicle=> vehicle.status == 2).sort((a, b) => parseFloat(b.id) - parseFloat(a.id)).map((vehicle, key) => (
