...
const Fees = (props) => {
  const {match, getFees, fees, createFee, updateFee, loading, deleteFee} = props;
  ...
  return (
    <div className="table-wrapper">
              ...
              {fees.map((fee, key) => (
                <li className="list-group-item text-right">
                  ...
                  <strong>
                    ...
                    <button type="button" className="rct-link-btn" onClick={() => verifyUserPermssion("create_setup", () => opnAddNewFeeEditModal(fee.fee_id))}>
      ...
      <Modal isOpen={addNewFeeModal} toggle={() => onAddUpdateFeeModalClose()}>
        <ModalHeader toggle={() => onAddUpdateFeeModalClose()}>{editFee ? "Update Class Type" : "Create New Class Type"}</ModalHeader>
