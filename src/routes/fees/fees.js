...
const  Fees = ({match, getAdmins, admins}) => {
        ...
        <div className="table-wrapper">
            ...
            <RctCollapsibleCard heading="Fees" fullBlock>
                <div className="float-right">
                    ...
                    <a href="#" onClick={(e) => opnAddNewUserModal(e)} color="primary" className="caret btn-sm mr-10">Add New Fee<i className="zmdi zmdi-plus"></i></a>
                                    ...
                                    <TableRow hover key={key}>
                                        <TableCell>
                                            <Media>
                                                ...
                                                {/*</Media>*/}
                                                <Media body><h5 className="m-0 pt-15">Cancellation</h5></Media>
                                            </Media>
                                        </TableCell>
            ...
            <Modal isOpen={addNewUserModal} toggle={() => onAddUpdateUserModalClose()}>
                <ModalHeader toggle={() => onAddUpdateUserModalClose()}>
                    {editUser ? 'Update Fee': 'Add New Fee'}
                </ModalHeader>
                <Form>
                    <ModalBody>
                                <FormGroup>
                                    <Label for="userName">Fee Type</Label>
