...
const  VerifiedDrivers = ({match,getDrivers, drivers, createDriver, isLoading}) => {
				...
				<RctCollapsibleCard heading="All Drivers" fullBlock>
					...
					<div className="table-responsive">
						<Table>
							...
							<TableBody>
								<Fragment>
									{drivers && drivers.filter(driver=> driver.status == 2).sort((a, b) => parseFloat(b.id) - parseFloat(a.id)).map((driver, key) => (
