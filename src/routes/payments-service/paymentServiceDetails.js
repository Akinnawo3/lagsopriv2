              ...
              <ul className="list-group">
                ...
                <li className="list-group-item text-right">
                  ...
                  {payment?.user_data?.length > 0 ? (
                    <Link to={payment?.user_data[0].user_type === "driver" ? `/admin/drivers/${payment?.auth_id}` : `/admin/passengers/${payment?.auth_id}`}>
                      {payment?.user_data[0]?.first_name} {payment?.user_data[0]?.last_name}
                    </Link>
                  ) : (
                    ""
                  )}
                ...
                <li className="list-group-item text-right">
                  ...
                  {payment?.user_data?.length > 0 ? payment?.user_data[0].user_type : ""}
                </li>
                <li className="list-group-item text-right">
                  <span className="pull-left">
                    <strong>User Phone</strong>
                  </span>
                  {payment?.user_data?.length > 0 ? payment?.user_data[0].phone_number : ""}
                </li>
                <li className="list-group-item text-right">
                  <span className="pull-left">
                    <strong>User Email</strong>
                  </span>
                  {payment?.user_data?.length > 0 ? payment?.user_data[0]?.email : ""}
                </li>
