...
const PendingPaymentService = ({history, match, getPayments, getPaymentsCount, payments, paymentsCount, getPaymentsServiceBalance}) => {
  ...
  return (
    <div className="table-wrapper">
      <PageTitleBar title={"Pending Payments"} match={match} />
...
export default connect(mapStateToProps, mapDispatchToProps)(PendingPaymentService);
