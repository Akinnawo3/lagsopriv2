...
const Others = ({
  ...
  return (
    <div className="table-wrapper">
                  ...
                  <div>
                    <FormGroup>
                      ...
                      <Input
                        type="text"
                        name="number"
                        value={customerCareNumbers.customer_care_line[0]}
                        required
                      />
                    </FormGroup>
                        ...
                        >
                          <FormGroup>
                            ...
                            <Input
                              type="text"
                              name="number"
                              value={customerCareNumbers.waiting_time}
                          ...
                          <Button
                            ...
                            onClick={() => setWaitingTimeModal(true)}
                          >
                            Update
                          </Button>
                        </Form>
      ...
      {/* waiting time modal */}
      <Modal
        isOpen={waitingTimeModal}
        toggle={() => setWaitingTimeModal(false)}
        size="sm"
      >
        <ModalHeader toggle={() => setWaitingTimeModal(false)}>
          Update Waiting Time
        </ModalHeader>
        <Form onSubmit={updateWaitingTime}>
          ...
          <ModalFooter>
            ...
            <Button
              variant="contained"
              className="btn btn-outline-danger"
              onClick={() => setWaitingTimeModal(false)}
            >
              Cancel
            </Button>
          </ModalFooter>
