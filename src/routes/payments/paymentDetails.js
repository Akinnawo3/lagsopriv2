                ...
                <div className="tab-content">
                    <div className="tab-pane active" id="home">
                        <ul className="list-group">
                            ...
                            <li className="list-group-item text-right"><span
                                className="pull-left"><strong>Rider Phone</strong></span>{sosUserDetails?.phone_number}
                            </li>
                            <li className="list-group-item text-right"><span
                                className="pull-left"><strong>Rider Email</strong></span>{sosUserDetails?.email}
                            </li>
                            <li className="list-group-item text-right"><span
                                className="pull-left"><strong>Trip Id</strong></span><Link to={`/admin/trips/${payment?.trip_id}`}>{payment?.trip_id}</Link>
                            </li>
                            <li className="list-group-item text-right"><span
                                className="pull-left"><strong>Trip Class</strong></span>{payment?.trip_class}
                            </li>
                            <li className="list-group-item text-right"><span
                                className="pull-left"><strong>Number of Trails</strong></span>{payment?.trials}
                            </li>
                            <li className="list-group-item text-right"><span
                            ...
                            <li className="list-group-item text-right"><span
                                ...
                                color={getStatusColor4(payment?.status)}>{getStatus4(payment?.status)}</Badge>
                            </li>
                        </ul>
                    </div>
                </div>
