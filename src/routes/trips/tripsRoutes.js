...
// async components
import {AsyncTrips, AsyncTripDetails, AsyncTripsCompleted, AsyncTripsCancelled, AsyncTripsWaiting, AsyncTripsCurrent, AsyncTripsDriverNotFound} from "Components/AsyncComponent/AsyncComponent";
...
const TripRoutes = ({match}) => (
  <div className="content-wrapper">
    <Switch>
      ...
      <Route path={`/admin/trips/driver-not-found`} component={AsyncTripsDriverNotFound} />
