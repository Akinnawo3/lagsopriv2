...
const  TripsTable = ({ trips, getTrips, isLoading,  tripCount, status}) => {
	...
	const paginate = pageNumber => {
		...
		getTrips(pageNumber, status);
		window.scrollTo(0, 0);
	};

	return (
			<div>
				{!isLoading && trips.length > 0 && <RctCollapsibleCard heading="All Trips" fullBlock>
